...
# Path to your top transaction data
path = r"C:\Users\luna love\Downloads\Phonepe\pulse\data\top\transaction\country\india\state"
top_trans_state_list = os.listdir(path)
#print("States found:", top_trans_state_list)
